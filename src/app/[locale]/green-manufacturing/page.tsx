 ...
 * four verticals are addressable. Green Manufacturing previously rendered only as a
 * panel of the home screen behind `?view=capabilities`, which is one URL to a
 * crawler and showed whichever pathway the cookie held. Because the cookie defaults to industrial, its four sectors appeared in no crawl of any URL at all.
 ...
 */
export default async function GreenManufacturingPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
